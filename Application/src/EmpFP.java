...
public class EmpFP extends HttpServlet {
	...
	OTP o=new OTP();
	int otp=o.otp();
	String otp1 = Integer.toString(otp); //WrapperClass method
	...
	String resetlink="http://localhost:8089/Application/empFPR.html";// mail subject line
	String msg="Hi"+ " "+eemail+" /n "+" "+resetlink+" "+otp; //mail body
	...
	response.sendRedirect("/Application/successSendMail.html");
	}
	catch(Exception e)
	{
		e.printStackTrace();
